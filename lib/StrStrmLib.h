...
namespace sstrm
{
   ...
   {
      std::string val; std::stringstream strm(str);
      strm >> val;
      return val;
   }
   ...
   { std::stringstream strm(str); strm >> d; return d; }
   inline float FromStr(float & f, std::string const& str)
   { std::stringstream strm(str); strm >> f; return f; }
   inline ulong FromStr(ulong & ul, std::string const& str)
   { std::stringstream strm(str); strm >> ul; return ul; }
   inline long FromStr(long & l, std::string const& str)
   { std::stringstream strm(str); strm >> l; return l; }
   inline int FromStr(int & i, std::string const& str)
   { std::stringstream strm(str); strm >> i; return i; }
   inline uint FromStr(uint & ui, std::string const& str)
   { std::stringstream strm(str); strm >> ui; return ui; }
   ...
   struct Converter
   {
	 ...
	 return *this;
      ...
      Converter & operator<<(const double d) { strm << d; return *this; }
      Converter & operator<<(const float f) { strm << f; return *this; }
      Converter & operator<<(const long l) { strm << l; return *this; }
      Converter & operator<<(const int i) { strm << i; return *this; }
